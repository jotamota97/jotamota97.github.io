...
// If EXPOSE_PRIVATE_METHODS
EXPOSE( "EventListenerList", EventListenerList ); // Endif
...
// If EXPOSE_PRIVATE_METHODS
EXPOSE( "BinaryTree", BinaryTree ); // Endif
...
// If EXPOSE_PRIVATE_METHODS
EXPOSE( "RouterPathGetParams", getParams ); // Endif
...
// If EXPOSE_PRIVATE_METHODS
EXPOSE( "motaViewData", motaViewData ); // Endif
...
// If EXPOSE_PRIVATE_METHODS
mota.PRIVATE_METHODS = PRIVATE_METHODS; // Endif
